...
module.exports = function (context) {
  return {
    CallExpression: function CallExpression(node) {
      var ancestors = context.getAncestors().map(function (ancestor) {
      ...
      if (!compareArrays(ancestors, ['Program', 'ExpressionStatement']) && !compareArrays(ancestors, ['Program', 'VariableDeclaration', 'VariableDeclarator'])) return;
